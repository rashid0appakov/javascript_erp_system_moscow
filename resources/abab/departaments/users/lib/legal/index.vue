...
<v-sheet class="fill-height">
	<v-navigation-drawer v-model="selectedLead" absolute right touchless width="100%">
		<lead @close="selectedLead = false" v-if="selectedLead" :departament="d_logistic" :lead_id="selectedLead.id"></lead>
	</v-navigation-drawer>
	<v-toolbar dense flat>
		<v-toolbar-title>Отдел логистики</v-toolbar-title>
		<v-spacer></v-spacer>
	</v-toolbar>
	<v-card-text>
